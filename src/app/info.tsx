...
const INFO_ARTICLES: InfoArticle[] = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      'По умолчанию приложение считает эти значения автоматически из планового отбоя и количества дневных снов. Ручные значения нужны только если вечерние подсказки регулярно не подходят вашему ребенку.',
